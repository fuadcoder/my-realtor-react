          ...
          <div className="flex space-x-6 justify-start mb-6">
            <div className="">
              ...
              <input
                ...
                min="-90"
                max="90"
                className="w-full px-4 py-2 text-gray-700 bg-white border border-gray-300 rounded transition duration-200 ease-in-out focus:bg-white focus:text-gray-700 focus:border-slate-600 text-center"
              />
            </div>
            <div className="">
