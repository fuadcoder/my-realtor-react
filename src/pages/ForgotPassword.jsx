    ...
    <section>
      ...
      <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto">
        <div className="md:w-[67%] lg:w-[50%] mb-12 md:mb-6">
          <img
            src="https://img.freepik.com/free-photo/flat-lay-real-estate-concept_53876-14502.jpg?w=996&t=st=1682534837~exp=1682535437~hmac=975b95464fa0ebe587d492c9161e26b514ef35ac1f26614e7557b5d0ae791f99"
            alt="key"
            className="w-full rounded-2xl h-[27rem]"
          />
        </div>
